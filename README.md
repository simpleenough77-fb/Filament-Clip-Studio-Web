...
The accepted revision-10 `author/Accepted_Geometry.scad` is unchanged. Bambu width is 68 mm, Cookiecad 62.5 mm, plate thickness 3.6 mm, and retainer corner radius 3 mm. The owner accepted physical prototype fits. These clips are filament retainers, not spool carrying handles.
